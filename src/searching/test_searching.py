...
class SearchingTests(unittest.TestCase):
    ...
    def test_binary_search_recursive(self):
        ...
        self.assertEqual(binary_search_recursive(arr1, -8))
        self.assertEqual(binary_search_recursive(arr1, 0))
        self.assertEqual(binary_search_recursive(arr2, 9))
        self.assertEqual(binary_search_recursive(arr2, 0))
